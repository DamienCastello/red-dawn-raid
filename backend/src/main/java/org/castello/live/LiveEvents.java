...
public class LiveEvents {
        ...
        public LiveEvents(SimpMessagingTemplate tpl) {
                this.tpl = tpl;
        }
        ...
        /**
         * Déclenché dès que les cartes du centre passent face visible (pour animer le
         * “flip”).
         */
        ...
        public void combatResolved(Game g, String roundId, int dmg, String defenderId, int defenderHp,
        ...
        public void biteRolled(Game g, int roll, String attackerId, String targetId, Integer newCorruption,
                        boolean becameServant, boolean isSacredRosaryUsed) {
                send(g.getId(), new GameEvents(
        ...
        public void unstableAssigned(Game g, String unstableId, String kind, String value) {
                ...
                if (value != null)
                        payload.put("value", value); // on n'ajoute pas "value" si null
